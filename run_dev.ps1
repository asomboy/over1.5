...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "Set-Location '$ScriptDir\backend'; & '$ScriptDir\backend\venv\Scripts\python.exe' -m uvicorn main:app --reload --port 8000"
